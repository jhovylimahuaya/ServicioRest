...
public class http extends MainActivity {
    ...
    public void client_server () {
        ...
        try { // Capto las excepciones que se puedan producir
            ...
            if (response != null) { // Cuando se recibe la respuesta del servidor
                ...
                Toast.makeText(this, "No se puede completar su Peticion", Toast.LENGTH_LONG).show();
            }
        } catch (ClientProtocolException e) {
            Toast.makeText(this, "\n" + "Excepción de protocolo de cliente", Toast.LENGTH_SHORT).show();
        } catch (IOException e) {
            Toast.makeText(this, "Excepcion IO Detectada", Toast.LENGTH_SHORT).show();
        } catch (Exception e) {
            Toast.makeText(this, "Excepcion Detectada", Toast.LENGTH_SHORT).show();
        }
    ...
    private String convertStreamToString(InputStream is) {
        ...
        try {
            ...
            Toast.makeText(this, "Excepcion de Flujo", Toast.LENGTH_SHORT).show();
        }
